...
AppId={{0EB5000F-9BCB-417D-9998-F505C063BE60}       
AppName={#MyAppName}
...
; Name: "msvc2017redist"; Description: "Install Microsoft VC2017 Redistributable";
...
Source: "./{#MyAdditionToolsFolder}/*"; DestDir: "{tmp}"; Flags: ignoreversion
; NOTE: Don't use "Flags: ignoreversion" on any shared system files

[Icons]
IconFilename: "{app}\logo.ico"; Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; 
IconFilename: "{app}\logo.ico"; Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"; 
IconFilename: "{app}\logo.ico"; Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; 
IconFilename: "{app}\logo.ico"; Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; 
...
Filename: "{tmp}\VC_redist.x86.exe"; Parameters: /silent; StatusMsg: "Installing Microsoft VS2017 Redistributable";
