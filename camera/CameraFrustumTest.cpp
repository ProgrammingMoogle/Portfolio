...
//     cl /EHsc CameraFrustumTest.cpp Affine.lib Render.lib SimpleRender.lib        Camera.cpp FrustumMesh.cpp opengl32.lib glew32.lib SDL2.lib SDL2main.lib /link /subsystem:console
// Under Linux:
