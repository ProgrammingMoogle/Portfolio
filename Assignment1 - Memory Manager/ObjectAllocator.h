...
\brief  
  ...
  of classes called OAException and ObjectAllocator with structs OAConfig,
  OAStats, GenericObject and MemBlockInfo.   
...
class ObjectAllocator
{
  public:
    ...
    void *Allocate(const char *label = 0); //throws OAException
  ...
  private:
    ...
    GenericObject* mPageList; //!< the beginning of the list of pages
    GenericObject* mFreeList; //!< the beginning of the list of objects
    ...
    void AddToFreeList(void* Object);

    unsigned int mLeftSize;
    unsigned int mInterSize;
    unsigned int mRightSize;

    //Helper Functions
    void InitPage(GenericObject* StartPage);
    void SetMemNMove(unsigned char** Begin, int Value, size_t Size);
    void SetNonDataPattern(unsigned char** Begin, size_t AlignSize);
    void MoveFreeList(unsigned char* Position);
    bool IsObjectFreeList(void* Object) const;
    void FreeExternalHeader(unsigned char* Object);
    void FreePage(GenericObject* pageHead);
    //Debug Checks for Free
    void CheckBounds(unsigned char* Object) const;
    void CheckTwoFree(unsigned char* Object) const;
    void CheckCorruption(unsigned char* Object) const;
